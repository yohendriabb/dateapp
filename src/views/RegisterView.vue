...
<div id="toast-default" class="flex justify-content: flex-end items-center mt-3  w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    ...
    <form class="bg-blue-400 shadow-md rounded px-8 pt-6 pb-8 mb-4">
      ...
      <div class="mb-6">
        ...
        <input v-model="password"
          ...
          <label  class="text-sm mt-2 text-slate-100 bg-red-900">Correo o contraseña incorrecta </label>
